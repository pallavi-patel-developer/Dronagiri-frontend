        ...
        <div className="max-w-5xl mx-auto">
          {!isLoaded ? (
            ...
            <div className="max-w-md mx-auto text-center py-20 bg-white rounded-3xl border border-gray-100 shadow-lg px-6 animate-fade-in-up">
              <div className="inline-flex items-center justify-center w-20 h-20 rounded-full bg-green-50 text-green-700 mb-6 shadow-inner">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                  <p className="text-sm font-semibold text-green-700 uppercase tracking-widest">
                ...
                <Link
                  href="/products"
                  className="inline-flex items-center gap-2 text-green-700 hover:text-green-800 font-semibold transition-all duration-200 group self-start sm:self-auto"
                >
                ...
                >
                  <div className="p-5 sm:p-6 border-b border-gray-100 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div className="flex items-start gap-4">
                      <div className="h-12 w-12 rounded-2xl bg-green-50 text-green-700 flex items-center justify-center shrink-0">
                        {order.source === "admin" ? (
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 text-sm lg:min-w-[420px]">
                      ...
                      <div className="bg-green-50 rounded-2xl p-3 col-span-2 sm:col-span-1">
                        <p className="text-green-700/70 text-xs font-semibold uppercase">
                          Total
                        </p>
                        <p className="text-green-800 font-black mt-1">
                          Rs. {order.total}
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="p-5 sm:p-6 grid lg:grid-cols-[1fr_280px] gap-6">
                    <div className="flex flex-col gap-3">
                      {order.items?.map((item) => (
                        <div
                          key={`${order.orderId}-${item.product.id}-${item.size}`}
                          className="flex items-center gap-4 rounded-2xl border border-gray-100 bg-gray-50/50 p-3"
                        >
                          <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-green-50 via-lime-50 to-amber-50 flex items-center justify-center text-green-700 shrink-0">
                            <ProductIcon
